...
fn peel1_test() {
    for src in [
        quote! { while cond { body; break; } },
        quote! { 'loop_label: while cond { body; break; } },
        quote! { 'loop_label: while cond { body; break 'loop_label; } },
    ] {
        ...
        assert_eq!(
            ...
            quote! {
                'loop_label: while true {
                    if cond { body; break 'loop_label; } else { break 'loop_label; }
                    while cond { body; break 'loop_label; }
                    break 'loop_label;
                }
                rest
            }
